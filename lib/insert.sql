...
VALUES (first_instance),
  ...
  */
  ...
  /* ruby multi-line syntax helper - USE THIS FOR CALLING SQL in ruby classes
 var = <<~WORD
 line1
 line2
 line3 ...
 WORD
looks like: var = "line1/n line2/n line3/n ..."
puts like: line1
           line2
           line3 ...

    == ADD TO THIS FOR SQL IN RUBY ==
    for self.
...
INSERT INTO users
VALUES (1, "Nich", 33), (7, "Kim", 30), (14, "Rafa", 9),
(2, "Nate", 35), (8, "Kate", 20), (15, "Randy", 8),
(3, "Nicole", 37), (9, "Kourt", 10), (16, "Rachel", 7), (17, "Amanda", 45),
(4, "Name", 33), (10, "Kat", 30), (18, "Roger", 9),
(5, "Nora", 35), (11, "Katrina", 20), (19, "Roma", 8),
(6, "Nikki", 37), (13, "Kenny", 10), (20, "Wilma", 7), (12, "Allison", 45);
